...
const config = {
  ...
  "inlineSchema": "// ─── Auth DB — MySQL (hangardb_bedi64240) ──────────────────────────────────\n// Generate: npm run generate:auth\n// Push:     npx prisma db push --schema=prisma/auth.prisma\n\ngenerator authClient {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma-auth\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\n// Prisma model name = User → accessor: prisma.user\n// SQL table name    = user  (controlled by @@map)\nmodel User {\n  id            String    @id @default(cuid())\n  name          String?\n  email         String?   @unique\n  emailVerified DateTime?\n  image         String?\n  password      String?\n  username      String?   @unique\n  createdAt     DateTime  @default(now())\n  updatedAt     DateTime  @updatedAt\n\n  sessions Session[]\n  accounts Account[]\n\n  @@map(\"user\")\n}\n\nmodel Account {\n  id                String  @id @default(cuid())\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.Text\n  access_token      String? @db.Text\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.Text\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n  @@map(\"account\")\n}\n\nmodel Session {\n  id           String   @id @default(cuid())\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@map(\"session\")\n}\n\n// VerificationToken not needed — using strategy:\"jwt\" + Credentials only\n",
  "inlineSchemaHash": "e6d22823c23bd0148998a05404502cd5f743def2ff3abb311a89888970ea5abb",
  "copyEngine": true
}
...
path.join(process.cwd(), "app/generated/prisma-auth/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "app/generated/prisma-auth/schema.prisma")
